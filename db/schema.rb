...
ActiveRecord::Schema.define(version: 20_190_627_204_447) do
  ...
  create_table 'project_addons', id: :serial, force: :cascade do |t|
    ...
    t.index %w[project_id addon_id], name: 'index_project_addons_on_project_id_and_addon_id', unique: true
  ...
  create_table 'project_stencils', id: :serial, force: :cascade do |t|
    ...
    t.index %w[stencil_id project_id], name: 'index_project_stencils_on_stencil_id_and_project_id', unique: true
  ...
  create_table 'seats', id: :serial, force: :cascade do |t|
    ...
    t.index %w[workshop_id user_id item_description_id], name: 'index_seats_on_workshop_id_and_user_id_and_item_description_id', unique: true
  ...
  create_table 'stencils', id: :serial, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[name stencil_category_id], name: 'index_stencils_on_name_and_stencil_category_id', unique: true
  ...
  create_table 'workshop_projects', id: :serial, force: :cascade do |t|
    ...
    t.index %w[workshop_id project_id], name: 'index_workshop_projects_on_workshop_id_and_project_id', unique: true
