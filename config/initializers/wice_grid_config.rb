...
if defined?(Wice::Defaults)
  ...
  Wice::Defaults::DEFAULT_TABLE_CLASSES = %w[table table-hover card-table].freeze
  ...
  Wice::Defaults::ADDITIONAL_COLUMN_PROCESSORS = {
    timeframe_picker: %w[ViewColumnTimeFramePicker ConditionsGeneratorColumnTimeFramePicker]
  }.freeze
  ...
  Wice::Defaults::SHOW_ALL_ALLOWED_UP_TO = 1000
